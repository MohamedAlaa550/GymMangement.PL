        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_GymUser_Email_ValidFormat", "[Email] LIKE '_%@_%._%'");
                    table.CheckConstraint("CK_GymUser_Phone_ValidFormat", "[Phone] LIKE '01%' AND [Phone] NOT LIKE '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_GymUser_Email_ValidFormat1", "[Email] LIKE '_%@_%._%'");
                    table.CheckConstraint("CK_GymUser_Phone_ValidFormat1", "[Phone] LIKE '01%' AND [Phone] NOT LIKE '%[^0-9]%'");
                });
